            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 border border-gray-300">
                ...
                <form noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="email" placeholder="email" className="border border-gray-300 w-full px-4 py-3 rounded-md bg-gray-50 text-gray-800 focus:border-purple-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-end text-xs text-gray-600">
                            <Link className='hover:underline text-purple-500' rel="noopener noreferrer" to='/forgot_password'>Forgot Password?</Link>
                        </div>
                    </div>
                ...
                <div className="flex items-center pt-4 space-x-1">
                    ...
                    <p className="px-3 text-sm text-gray-600">Enter with social accounts</p>
                    <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
                </div>
                ...
                <p className="text-xs text-center sm:px-6 text-gray-600">Don't have an account?
                    <Link rel="noopener noreferrer" to='/register' className="text-purple-500 hover:underline">Sign up</Link>
                </p>
            </div>
        </div>
    );
